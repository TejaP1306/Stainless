...
from ._exceptions import MarginError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Margin", "AsyncMargin", "Client", "AsyncClient"]


class Margin(SyncAPIClient):
    pets: pets.PetsResource
    store: store.StoreResource
    users: users.UsersResource
    with_raw_response: MarginWithRawResponse
    with_streaming_response: MarginWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Margin client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("MARGIN_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = MarginWithRawResponse(self)
        self.with_streaming_response = MarginWithStreamedResponse(self)
...
class AsyncMargin(AsyncAPIClient):
    pets: pets.AsyncPetsResource
    store: store.AsyncStoreResource
    users: users.AsyncUsersResource
    with_raw_response: AsyncMarginWithRawResponse
    with_streaming_response: AsyncMarginWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncMargin client instance.
        ...
        self.with_raw_response = AsyncMarginWithRawResponse(self)
        self.with_streaming_response = AsyncMarginWithStreamedResponse(self)
...
class MarginWithRawResponse:
    def __init__(self, client: Margin) -> None:
...
class AsyncMarginWithRawResponse:
    def __init__(self, client: AsyncMargin) -> None:
...
class MarginWithStreamedResponse:
    def __init__(self, client: Margin) -> None:
...
class AsyncMarginWithStreamedResponse:
    def __init__(self, client: AsyncMargin) -> None:
